...
import bodyBG from '../assets/LandingPage/body-bg.svg';
...
import kids from '../assets/LandingPage/kids.svg';
        ...
        <div className="bg-landing-page-bg">
            ...
            <section
                ...
                <div className="md:flex-1 md:mr-10">
                    <h1 className="text-5xl font-bold font-pt-serif mb-7 text-zinc-800 font-sourceSans3">
                        ...
                        <span className="bg-left-bottom bg-no-repeat pb-2 bg-100%">
                            Learning and Fun
                        </span>
                    </h1>
                    <p className="font-normal font-pt-serif mb-7">
                        Embark on an educational adventure like no other as this website combines learning with exciting games,
                        turning knowledge into a thrilling quest.
                    </p>
                    <div className="font-montserrat">
                        <Link to='/Student_Login'>
                            <button className="px-6 py-4 mb-2 mr-2 text-white border-2 border-black border-solid rounded-lg bg-zinc-800 font-expletus">
                                Student Login
                            </button></Link>
                        <Link to='/TeacherLogin'>
                            <button className="px-6 py-4 text-white border-2 border-solid rounded-lg bg-rose-500 border-rose-500 font-expletus">
                                Teacher Login
                            </button></Link>
                    </div>
                </div>
            ...
            <section className="text-white bg-zinc-800 sectionSize" id="section-1">
                ...
                <div className="flex flex-col md:flex-row">
                    <div className="flex flex-col items-center flex-1 mx-8 my-4">
                        <div className="flex items-center justify-center w-12 h-12 mb-3 text-white border-2 rounded-full bg-secondary">
                            1
                        </div>
                        <h3 className="mb-2 text-xl font-medium font-montserrat">Learning</h3>
                        <p className="text-center font-montserrat">
                            Learning subjects through a welcoming and exciting way.
                        </p>
                    </div>
                    <div className="flex flex-col items-center flex-1 mx-8 my-4">
                        <div className="flex items-center justify-center w-12 h-12 mb-3 text-white border-2 rounded-full bg-secondary">
                        ...
                        <p className="text-center font-montserrat">
                            Combine learning with games that keeps the students entertained and engaged.
                        </p>
                    </div>
                    <div className="flex flex-col items-center flex-1 mx-8 my-4">
                        <div className="flex items-center justify-center w-12 h-12 mb-3 text-white border-2 rounded-full bg-secondary">
                        ...
                        <p className="text-center font-montserrat">
                            Improve the critical thinking and challenge the students to think out of the box.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="md:grid md:grid-cols-2 md:grid-rows-2">
                    ...
                    <div className="flex items-start my-6 mr-10 font-montserrat">
                        ...
                        <div>
                            ...
                            <p>
                                Provide the students with lectures whether through documents or videos
                                to keep them engaged and provide relevant information to the subjects.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start my-6 mr-10 font-montserrat">
                        ...
                        <div>
                            ...
                            <p>
                                Challenge and test the knowledge of the students through instructor
                                created assessment that tests how much the student understood the lessons.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start my-6 mr-10 font-montserrat">
                        ...
                        <div>
                            ...
                            <p>
                                Provide an opportunity to the student to learn through an interavtive
                                way with games that test their knowledge and critical thinking abilities.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start my-6 mr-10 font-montserrat">
                        ...
                        <div>
                            ...
                            <p>
                                Develop friendships and lasting meaningful exchanges with classNamemates
            ...
            <section className="bg-zinc-800 sectionSize">
                <div className="text-sm text-white font-montserrat">
                    © 2023 EDUPLAY. All rights reserved
                </div>
            </section>
        </div>
    );
