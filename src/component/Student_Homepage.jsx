            ...
            <div className='backgroundYellow'>
                ...
                <div className='m-4  lg:p-0 rounded-full grid lg:grid-cols-[32.5%_32.8%_32.6%] lg:gap-5 gap-5  '>
                    ...
                    <div className='flex flex-col items-center bg-gradient-to-r from-green-300 via-teal-300 to-cyan-200 rounded-xl homepageParent '>
                        ...
                        <div className='bg-[#ff5757] text-3xl font-bold p-2 text-white rounded-xl px-5 mb-5 font-sourceSans3 hover:bg-red-600 hover:textblack transition ease-in-out delay-150s placeholder-white'>
                    ...
                    <div className='flex flex-col items-center bg-gradient-to-tr from-rose-100 to-rose-200 rounded-xl homepageParent'>
                        ...
                        <a href="#">
                            <div className='bg-[#C27575] text-3xl font-bold p-2 text-white rounded-xl px-5 mb-5 font-sourceSans3 hover:bg-orange-800 hover:textblack transition ease-in-out delay-150s'>
                    ...
                    <div className='flex flex-col items-center bg-gradient-to-l from-sky-300 via-cyan-300 to-cyan-500 rounded-xl homepageParent '>
                        ...
                        <a href="#">
                            <div className='bg-[#5271ff] mt-14 text-3xl font-bold p-2 text-white rounded-xl px-5 mb-5 font-sourceSans3 hover:bg-blue-800 hover:textblack transition ease-in-out delay-150s'>
